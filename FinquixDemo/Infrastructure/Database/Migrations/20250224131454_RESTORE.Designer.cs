...
namespace FinquixDemo.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250224131454_RESTORE")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinquixDemo.Models.CryptoAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinquixDemo.Models.FinancialData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinquixDemo.Models.FinancialGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinquixDemo.Models.FinancialSignal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinquixDemo.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinquixDemo.Models.FinancialData", b =>
                {
                    b.HasOne("FinquixDemo.Models.UserProfile", "UserProfile")
                        .WithOne("FinancialData")
                        .HasForeignKey("FinquixDemo.Models.FinancialData", "UserProfileId")
